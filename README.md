...
| Name                  | Workspace / Bradley |
| Description           | A ChiliPeppr Workspace sample. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/mbradleyis/workspace-sample/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/mbradleyis/workspace-sample |
| Github URL            | http://github.com/mbradleyis/workspace-sample |
| Test URL              | https://preview.c9users.io/mbradleyis/workspace-sample/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/mbradleyis/workspace-sample/master/auto-generated-workspace.html",
  function() {
    ...
    cprequire(
      ...
      function(myWorkspaceSample) {
        ...
        console.log("Workspace / Bradley just got loaded.", myWorkspaceSample);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-sample"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / Bradley"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace sample."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/mbradleyis/workspace-sample/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/mbradleyis/workspace-sample"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/mbradleyis/workspace-sample"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-sample-mbradleyis.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
